...
import {LoginoneComponent1} from './loginone/loginone.component1';
import {LoginoneComponent2} from './loginone/loginone.component2';
...
export const SessionRoutes: Routes = [{
  ...
  children: [{
    ...
    {
      path: 'loginone1',
      component: LoginoneComponent1
    },
    {
      path: 'loginone2',
      component: LoginoneComponent2
    }]
}];
